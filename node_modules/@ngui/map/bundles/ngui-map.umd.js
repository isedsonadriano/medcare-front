(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@ngui/map', ['@angular/core','@angular/common','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
	(factory(global.ng.core,global.ng.common,(global.ngui = global.ngui || {}, global.ngui.map = {}),global.ng.core,global.rxjs,global.Rx.Observable.prototype,global.ng.common));
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InfoWindow, [{
        ...
        args: [{
            ...
            type: core.ViewChild,
            args: ['template', { read: core.ViewContainerRef }]
        }] }); })();
    return InfoWindow;
}());
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NguiMapModule, { declarations: [NguiMapComponent,
        InfoWindow,
        Marker,
        Circle,
        CustomMarker,
        ...
        PlacesAutoComplete,
        DirectionsRenderer,
        DrawingManager], imports: [ɵngcc1.CommonModule], exports: [NguiMapComponent,
        InfoWindow,
        Marker,
        Circle,
        CustomMarker,
